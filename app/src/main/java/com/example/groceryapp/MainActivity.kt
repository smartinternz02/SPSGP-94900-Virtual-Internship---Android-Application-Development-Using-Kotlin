...
class MainActivity : AppCompatActivity() ,GroceryRVAdapter.GroceryItemClickInterface{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val groceryRepositry=GroceryRepositry(GroceryDatabase(this))
        val factory=GroceryViewModalFactory(groceryRepositry)
    ...
    fun openDialog(){
        ...
        val itemNa=dialog.findViewById<TextInputEditText>(R.id.idEditItemName)
        val itemPriceEdt=dialog.findViewById<TextInputEditText>(R.id.idEditItemPrice)
        val itemQuantityEdt=dialog.findViewById<TextInputEditText>(R.id.idEditItemQuantity)
        CancelBtn.setOnClickListener{
            dialog.dismiss()
        }
        AddBtn.setOnClickListener{
            val itemName:String=itemNa.text.toString()
